...
export const globalAgentInstructionSourceInputs: InstructionSourceInput[] = [
  {
    ...
    content: lines([
      ...
      "",
      "Apply a minimum adversarial verification policy across normal answers, user-requested audits, deep research, implementation, QA, and release work. Normal answers need adversarial scrutiny when accuracy, safety, user impact, or source interpretation matters. User-requested audits and deep research require explicit adversarial challenge of assumptions, evidence, freshness, and conclusions.",
      "",
      "Implementation, code, config, release, publish, local rollout, fleet rollout, operational, QA, and final verification work require an independent adversarial reviewer whenever one can be spawned. Coordinator sessions must use at least one adversarial reviewer for verification and usually two for substantial or high-risk work. If no adversarial agent can be spawned, perform and label an adversarial self-review with the same standards. Reconcile findings before marking work complete.",
      "",
  ...
  },
  {
    ...
    content: lines([
      ...
      "7. Minimum adversarial verification applies to normal answers, user-requested audits, deep research, implementation/code/config changes, release/publish/local/fleet rollout work, QA, and final verification. Challenge assumptions, source quality, freshness, edge cases, regressions, safety, and whether the evidence actually proves the claim.",
      "8. Coordinators must use at least one adversarial reviewer for verification and usually two for substantial or high-risk work. If no adversarial agent can be spawned, perform and label an adversarial self-review with the same standards, then reconcile findings before marking work complete.",
      "9. Secrets safety is mandatory. Never expose credential values. Run the staged secrets scan before every commit and push. Remove any detected credential from the diff before continuing.",
      "10. Commit messages must not include Co-Authored-By trailers.",
      "11. Prefer Bun in Hasna JavaScript and TypeScript repositories. Preserve Bun's release-age quarantine and add exact new Hasna package names to the release-age exclusion registry when applicable.",
    ]),
    owner: { kind: "global", id: "global", name: "Hasna Global Agent Rules" },
    sensitivity: "internal",
    mergePolicy: "append",
