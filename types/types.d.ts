export declare const identityDocumentKeys: readonly ["bio", "prompt", "soul", "personality", "ethos", "capabilities", "boundaries", "tools", "relationships", "goals", "context", "memory", "consent", "voice"];
...
export declare const instructionSourceKinds: readonly ["global-rules", "provider-rules", "global-system-prompt", "provider-system-prompt", "identity-doc", "persona-doc", "account-overlay", "machine-overlay", "project-overlay", "session-overlay"];
export type InstructionSourceKind = (typeof instructionSourceKinds)[number];
export declare const instructionOwnerKinds: readonly ["global", "provider", "identity", "persona", "account", "machine", "project", "session"];
export type InstructionSourceOwnerKind = (typeof instructionOwnerKinds)[number];
export declare const instructionSensitivityLevels: readonly ["public", "internal", "confidential", "secret"];
export type InstructionSensitivity = (typeof instructionSensitivityLevels)[number];
export declare const instructionMergePolicies: readonly ["append", "replace"];
export type InstructionMergePolicy = (typeof instructionMergePolicies)[number];
export declare const instructionSafetyClasses: readonly ["standard", "safety", "non-overridable-safety"];
export type InstructionSafetyClass = (typeof instructionSafetyClasses)[number];
export declare const instructionProviderStrategies: readonly ["native", "import", "managed-block", "rendered", "unsupported"];
...
export type IdentityMachineAssignmentInput = string | (Omit<IdentityMachineAssignment, "status" | "assignedAt"> & Partial<Pick<IdentityMachineAssignment, "status" | "assignedAt">>);
...
export type BrowserPlanProfileReservationInput = Omit<BrowserPlanProfileReservation, "id" | "profileName" | "email" | "status" | "reservedAt"> & Partial<Pick<BrowserPlanProfileReservation, "id" | "profileName" | "email" | "status" | "reservedAt">>;
